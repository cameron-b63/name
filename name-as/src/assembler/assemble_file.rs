...
use crate::assembler::assembler::{AssembleError, Assembler};
...
) -> Result<Assembler, Vec<AssembleError>> {
    todo!()
}
// pub fn assemble<'a>(
//     file_contents: &'a str,
//     current_dir: PathBuf,
//     line_prefix: Option<String>,
// ) -> Result<Assembler, Vec<AssembleError<'a>>> {
