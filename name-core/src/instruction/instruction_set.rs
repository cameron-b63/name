...
Intentionally excluded instructions:
 ...
 - CACHEE(1)    (Cache EVA)
 - CVT.PS.S(2)  (Convert Single to Paired Single)
 - CVT.S.PL(2)  (Convert Paired Single to Single, Lower)
 - CVT.S.PU(2)  (Convert Paired Single to Single, Upper)
...
pub static INSTRUCTION_SET: LazyLock<Vec<InstructionInformation>> = LazyLock::new(|| {
    vec![
        ...
        InstructionInformation {
            ...
            implementation: wrap_imp(implementation::div_s),
            args: &[&[ArgumentType::Fd, ArgumentType::Fs, ArgumentType::Ft]],
            relocation_type: None,
        },
        InstructionInformation {
